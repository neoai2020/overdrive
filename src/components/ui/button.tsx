...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-[10px] text-sm font-bold transition-all whitespace-nowrap disabled:opacity-50 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-acid)]/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--color-bg)]",
  {
    variants: {
      variant: {
        primary: "bg-[color:var(--color-acid)] text-black hover:-translate-y-px hover:shadow-[0_8px_24px_rgba(204,255,0,0.3)] active:translate-y-0",
        secondary: "bg-[color:var(--color-card)] text-[color:var(--color-ink)] border border-[color:var(--color-line)] hover:border-[color:var(--color-faint)]",
